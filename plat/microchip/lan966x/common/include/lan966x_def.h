...
#define LAN996X_PKCL_ROM_BASE	UL(0x00040000)
#define LAN996X_PKCL_ROM_SIZE	SIZE_K(64)
#define LAN996X_PKCL_RAM_BASE	UL(0x00051000)
#define LAN996X_PKCL_RAM_SIZE	SIZE_K(4)
#define LAN996X_QSPI0_MMAP	UL(0x20000000)
#define LAN996X_QSPI0_RANGE	SIZE_M(16)
#define LAN996X_DDR_BASE	UL(0x60000000)
#define LAN996X_DDR_SIZE	SIZE_M(512)
