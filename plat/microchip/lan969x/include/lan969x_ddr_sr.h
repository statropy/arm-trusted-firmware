...
#define CPU_DDRCTRL_CLK(t)        (t + 0x2e8)
...
#define CPU_DDRCTRL_RST(t)        (t + 0x2ec)
...
#define CPU_DDRC_INTR_RAW_STAT(t) (t + 0x2f0)
...
#define CPU_DDRC_INTR_MASK(t)     (t + 0x2f4)
...
#define CPU_DDRC_INTR_MASKED_STAT(t) (t + 0x2f8)
...
#define CPU_DRAM0_MPR_PAGE_STAT(t) (t + 0x2fc)

/*      CPU:DDRCTRL:DRAM1_MPR_PAGE_STAT */
#define CPU_DRAM1_MPR_PAGE_STAT(t) (t + 0x300)
