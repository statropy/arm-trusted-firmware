...
#define LAN969X_SILEX_RAM_BASE	UL(0x00040000)
#define LAN969X_SILEX_RAM_SIZE	SIZE_K(128)
#define LAN969X_SILEX_ROM_BASE	UL(0x00060000)
#define LAN969X_SILEX_ROM_SIZE	SIZE_K(128)
#define LAN969X_SILEX_REGS_BASE	UL(0x00080000)
#define LAN969X_SILEX_REGS_SIZE	SIZE_K(128)
#define LAN969X_QSPI0_MMAP	UL(0x20000000)
#define LAN969X_QSPI0_RANGE	SIZE_M(16)
#define LAN969X_DDR_BASE	UL(0x60000000)
#define LAN969X_DDR_ATF_SIZE	SIZE_M(512)
#define LAN969X_DDR_MAX_SIZE	SIZE_M(512 + 1024) /* Actually 2G, but we cannot fit the tables in BL2U */
