...
#define LAN969X_SILEX_REGS_BASE	UL(0x00040000)
#define LAN969X_SILEX_REGS_SIZE	SIZE_K(64)
#define LAN969X_SILEX_RAM_BASE	UL(0x00051000)
#define LAN969X_SILEX_RAM_SIZE	SIZE_K(4)
