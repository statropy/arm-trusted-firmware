...
/* This file is autogenerated by cml-utils 2023-09-07 11:26:59 +0200.
 * Commit ID: 2fa4f5ea16c0c7fbd4effb16be47a1fb2fa627ed
 */
...
#define CHIP_TOP_HW_STAT_JTAG_SEL(x)             (((x) << 2) & GENMASK(2, 2))
#define CHIP_TOP_HW_STAT_JTAG_SEL_M              GENMASK(2, 2)
#define CHIP_TOP_HW_STAT_JTAG_SEL_X(x)           (((x) & GENMASK(2, 2)) >> 2)

#define CHIP_TOP_HW_STAT_REFCLK_SEL(x)           (((x) << 1) & GENMASK(1, 1))
...
#define CHIP_TOP_DDR_PLL_FREQ_CFG_BYPASS_ENA(x)  (((x) << 31) & GENMASK(31, 31))
#define CHIP_TOP_DDR_PLL_FREQ_CFG_BYPASS_ENA_M   GENMASK(31, 31)
#define CHIP_TOP_DDR_PLL_FREQ_CFG_BYPASS_ENA_X(x)\
	(((x) & GENMASK(31, 31)) >> 31)

#define CHIP_TOP_DDR_PLL_FREQ_CFG_DIVFI(x)       (((x) << 24) & GENMASK(30, 24))
...
#define UVOV_UVOV_CTL(t)          (t + 0x00)

#define UVOV_UVOV_CTL_MST_OVR_DET_EN(x)          (((x) << 1) & GENMASK(1, 1))
#define UVOV_UVOV_CTL_MST_OVR_DET_EN_M           GENMASK(1, 1)
#define UVOV_UVOV_CTL_MST_OVR_DET_EN_X(x)        (((x) & GENMASK(1, 1)) >> 1)

#define UVOV_UVOV_CTL_MST_UVR_DET_EN(x)          ((x) & GENMASK(0, 0))
#define UVOV_UVOV_CTL_MST_UVR_DET_EN_M           GENMASK(0, 0)
#define UVOV_UVOV_CTL_MST_UVR_DET_EN_X(x)        ((x) & GENMASK(0, 0))

/*      UVOV:UVOV_REGS:UVOV_INT_STS */
#define UVOV_UVOV_INT_STS(t)      (t + 0x04)

#define UVOV_UVOV_INT_STS_TRIM_INT_STS(x)        (((x) << 24) & GENMASK(24, 24))
#define UVOV_UVOV_INT_STS_TRIM_INT_STS_M         GENMASK(24, 24)
#define UVOV_UVOV_INT_STS_TRIM_INT_STS_X(x)      (((x) & GENMASK(24, 24)) >> 24)

#define UVOV_UVOV_INT_STS_OVR_INT_STS_V09(x)     (((x) << 20) & GENMASK(20, 20))
#define UVOV_UVOV_INT_STS_OVR_INT_STS_V09_M      GENMASK(20, 20)
#define UVOV_UVOV_INT_STS_OVR_INT_STS_V09_X(x)   (((x) & GENMASK(20, 20)) >> 20)

#define UVOV_UVOV_INT_STS_UVR_INT_STS_V09(x)     (((x) << 16) & GENMASK(16, 16))
#define UVOV_UVOV_INT_STS_UVR_INT_STS_V09_M      GENMASK(16, 16)
#define UVOV_UVOV_INT_STS_UVR_INT_STS_V09_X(x)   (((x) & GENMASK(16, 16)) >> 16)

#define UVOV_UVOV_INT_STS_OVR_INT_STS_V12(x)     (((x) << 12) & GENMASK(12, 12))
#define UVOV_UVOV_INT_STS_OVR_INT_STS_V12_M      GENMASK(12, 12)
#define UVOV_UVOV_INT_STS_OVR_INT_STS_V12_X(x)   (((x) & GENMASK(12, 12)) >> 12)

#define UVOV_UVOV_INT_STS_UVR_INT_STS_V12(x)     (((x) << 8) & GENMASK(8, 8))
#define UVOV_UVOV_INT_STS_UVR_INT_STS_V12_M      GENMASK(8, 8)
#define UVOV_UVOV_INT_STS_UVR_INT_STS_V12_X(x)   (((x) & GENMASK(8, 8)) >> 8)

#define UVOV_UVOV_INT_STS_OVR_INT_STS_V18(x)     (((x) << 4) & GENMASK(4, 4))
#define UVOV_UVOV_INT_STS_OVR_INT_STS_V18_M      GENMASK(4, 4)
#define UVOV_UVOV_INT_STS_OVR_INT_STS_V18_X(x)   (((x) & GENMASK(4, 4)) >> 4)

#define UVOV_UVOV_INT_STS_UVR_INT_STS_V18(x)     ((x) & GENMASK(0, 0))
#define UVOV_UVOV_INT_STS_UVR_INT_STS_V18_M      GENMASK(0, 0)
#define UVOV_UVOV_INT_STS_UVR_INT_STS_V18_X(x)   ((x) & GENMASK(0, 0))

/*      UVOV:UVOV_REGS:UVOV_INT_EN */
#define UVOV_UVOV_INT_EN(t)       (t + 0x08)

#define UVOV_UVOV_INT_EN_TRIM_INT_EN(x)          (((x) << 24) & GENMASK(24, 24))
#define UVOV_UVOV_INT_EN_TRIM_INT_EN_M           GENMASK(24, 24)
#define UVOV_UVOV_INT_EN_TRIM_INT_EN_X(x)        (((x) & GENMASK(24, 24)) >> 24)

#define UVOV_UVOV_INT_EN_OVR_INT_EN_v09(x)       (((x) << 20) & GENMASK(20, 20))
#define UVOV_UVOV_INT_EN_OVR_INT_EN_v09_M        GENMASK(20, 20)
#define UVOV_UVOV_INT_EN_OVR_INT_EN_v09_X(x)     (((x) & GENMASK(20, 20)) >> 20)

#define UVOV_UVOV_INT_EN_UVR_INT_EN_v09(x)       (((x) << 16) & GENMASK(16, 16))
#define UVOV_UVOV_INT_EN_UVR_INT_EN_v09_M        GENMASK(16, 16)
#define UVOV_UVOV_INT_EN_UVR_INT_EN_v09_X(x)     (((x) & GENMASK(16, 16)) >> 16)

#define UVOV_UVOV_INT_EN_OVR_INT_EN_v12(x)       (((x) << 12) & GENMASK(12, 12))
#define UVOV_UVOV_INT_EN_OVR_INT_EN_v12_M        GENMASK(12, 12)
#define UVOV_UVOV_INT_EN_OVR_INT_EN_v12_X(x)     (((x) & GENMASK(12, 12)) >> 12)

#define UVOV_UVOV_INT_EN_UVR_INT_EN_v12(x)       (((x) << 8) & GENMASK(8, 8))
#define UVOV_UVOV_INT_EN_UVR_INT_EN_v12_M        GENMASK(8, 8)
#define UVOV_UVOV_INT_EN_UVR_INT_EN_v12_X(x)     (((x) & GENMASK(8, 8)) >> 8)

#define UVOV_UVOV_INT_EN_OVR_INT_EN_v18(x)       (((x) << 4) & GENMASK(4, 4))
#define UVOV_UVOV_INT_EN_OVR_INT_EN_v18_M        GENMASK(4, 4)
#define UVOV_UVOV_INT_EN_OVR_INT_EN_v18_X(x)     (((x) & GENMASK(4, 4)) >> 4)

#define UVOV_UVOV_INT_EN_UVR_INT_EN_v18(x)       ((x) & GENMASK(0, 0))
#define UVOV_UVOV_INT_EN_UVR_INT_EN_v18_M        GENMASK(0, 0)
#define UVOV_UVOV_INT_EN_UVR_INT_EN_v18_X(x)     ((x) & GENMASK(0, 0))

/*      UVOV:UVOV_CFG:TUNE */
#define UVOV_TUNE(t)              (t + 0x0c)

#define UVOV_TUNE_TUNE_CDR(x)                    (((x) << 24) & GENMASK(26, 24))
#define UVOV_TUNE_TUNE_CDR_M                     GENMASK(26, 24)
#define UVOV_TUNE_TUNE_CDR_X(x)                  (((x) & GENMASK(26, 24)) >> 24)

#define UVOV_TUNE_TUNE_M(x)                      (((x) << 18) & GENMASK(23, 18))
#define UVOV_TUNE_TUNE_M_M                       GENMASK(23, 18)
#define UVOV_TUNE_TUNE_M_X(x)                    (((x) & GENMASK(23, 18)) >> 18)

#define UVOV_TUNE_TUNE_MAG(x)                    (((x) << 12) & GENMASK(17, 12))
#define UVOV_TUNE_TUNE_MAG_M                     GENMASK(17, 12)
#define UVOV_TUNE_TUNE_MAG_X(x)                  (((x) & GENMASK(17, 12)) >> 12)

#define UVOV_TUNE_TRIM_EN(x)                     (((x) << 6) & GENMASK(6, 6))
#define UVOV_TUNE_TRIM_EN_M                      GENMASK(6, 6)
#define UVOV_TUNE_TRIM_EN_X(x)                   (((x) & GENMASK(6, 6)) >> 6)

/*      UVOV:UVOV_CFG:ATP_UVOV */
#define UVOV_ATP_UVOV(t)          (t + 0x10)

#define UVOV_ATP_UVOV_ATP_UVOV_SEL(x)            ((x) & GENMASK(1, 0))
#define UVOV_ATP_UVOV_ATP_UVOV_SEL_M             GENMASK(1, 0)
#define UVOV_ATP_UVOV_ATP_UVOV_SEL_X(x)          ((x) & GENMASK(1, 0))

/*      UVOV:UVOV_CFG:UVOV_CFG0_V09 */
#define UVOV_UVOV_CFG0_V09(t)     (t + 0x14)

#define UVOV_UVOV_CFG0_V09_OV_DEB_EN_V09(x)      (((x) << 28) & GENMASK(28, 28))
#define UVOV_UVOV_CFG0_V09_OV_DEB_EN_V09_M       GENMASK(28, 28)
#define UVOV_UVOV_CFG0_V09_OV_DEB_EN_V09_X(x)    (((x) & GENMASK(28, 28)) >> 28)

#define UVOV_UVOV_CFG0_V09_UV_DEB_EN_V09(x)      (((x) << 27) & GENMASK(27, 27))
#define UVOV_UVOV_CFG0_V09_UV_DEB_EN_V09_M       GENMASK(27, 27)
#define UVOV_UVOV_CFG0_V09_UV_DEB_EN_V09_X(x)    (((x) & GENMASK(27, 27)) >> 27)

#define UVOV_UVOV_CFG0_V09_OV_RST_EN_V09(x)      (((x) << 11) & GENMASK(11, 11))
#define UVOV_UVOV_CFG0_V09_OV_RST_EN_V09_M       GENMASK(11, 11)
#define UVOV_UVOV_CFG0_V09_OV_RST_EN_V09_X(x)    (((x) & GENMASK(11, 11)) >> 11)

#define UVOV_UVOV_CFG0_V09_UV_RST_EN_V09(x)      (((x) << 10) & GENMASK(10, 10))
#define UVOV_UVOV_CFG0_V09_UV_RST_EN_V09_M       GENMASK(10, 10)
#define UVOV_UVOV_CFG0_V09_UV_RST_EN_V09_X(x)    (((x) & GENMASK(10, 10)) >> 10)

#define UVOV_UVOV_CFG0_V09_OVR_RNG_SEL_V09(x)    (((x) << 4) & GENMASK(5, 4))
#define UVOV_UVOV_CFG0_V09_OVR_RNG_SEL_V09_M     GENMASK(5, 4)
#define UVOV_UVOV_CFG0_V09_OVR_RNG_SEL_V09_X(x)  (((x) & GENMASK(5, 4)) >> 4)

#define UVOV_UVOV_CFG0_V09_UVR_RNG_SEL_V09(x)    (((x) << 2) & GENMASK(3, 2))
#define UVOV_UVOV_CFG0_V09_UVR_RNG_SEL_V09_M     GENMASK(3, 2)
#define UVOV_UVOV_CFG0_V09_UVR_RNG_SEL_V09_X(x)  (((x) & GENMASK(3, 2)) >> 2)

#define UVOV_UVOV_CFG0_V09_OVR_DET_EN_V09(x)     (((x) << 1) & GENMASK(1, 1))
#define UVOV_UVOV_CFG0_V09_OVR_DET_EN_V09_M      GENMASK(1, 1)
#define UVOV_UVOV_CFG0_V09_OVR_DET_EN_V09_X(x)   (((x) & GENMASK(1, 1)) >> 1)

#define UVOV_UVOV_CFG0_V09_UVR_DET_EN_V09(x)     ((x) & GENMASK(0, 0))
#define UVOV_UVOV_CFG0_V09_UVR_DET_EN_V09_M      GENMASK(0, 0)
#define UVOV_UVOV_CFG0_V09_UVR_DET_EN_V09_X(x)   ((x) & GENMASK(0, 0))

/*      UVOV:UVOV_CFG:UVOV_CFG1_V09 */
#define UVOV_UVOV_CFG1_V09(t)     (t + 0x18)

#define UVOV_UVOV_CFG1_V09_UVOV_DEB_V09(x)       (((x) << 8) & GENMASK(31, 8))
#define UVOV_UVOV_CFG1_V09_UVOV_DEB_V09_M        GENMASK(31, 8)
#define UVOV_UVOV_CFG1_V09_UVOV_DEB_V09_X(x)     (((x) & GENMASK(31, 8)) >> 8)

#define UVOV_UVOV_CFG1_V09_OV_STS_V09(x)         (((x) << 1) & GENMASK(1, 1))
#define UVOV_UVOV_CFG1_V09_OV_STS_V09_M          GENMASK(1, 1)
#define UVOV_UVOV_CFG1_V09_OV_STS_V09_X(x)       (((x) & GENMASK(1, 1)) >> 1)

#define UVOV_UVOV_CFG1_V09_UV_STS_V09(x)         ((x) & GENMASK(0, 0))
#define UVOV_UVOV_CFG1_V09_UV_STS_V09_M          GENMASK(0, 0)
#define UVOV_UVOV_CFG1_V09_UV_STS_V09_X(x)       ((x) & GENMASK(0, 0))

/*      UVOV:UVOV_CFG:UVOV_CFG0_V12 */
#define UVOV_UVOV_CFG0_V12(t)     (t + 0x1c)

#define UVOV_UVOV_CFG0_V12_OV_DEB_EN_V12(x)      (((x) << 28) & GENMASK(28, 28))
#define UVOV_UVOV_CFG0_V12_OV_DEB_EN_V12_M       GENMASK(28, 28)
#define UVOV_UVOV_CFG0_V12_OV_DEB_EN_V12_X(x)    (((x) & GENMASK(28, 28)) >> 28)

#define UVOV_UVOV_CFG0_V12_UV_DEB_EN_V12(x)      (((x) << 27) & GENMASK(27, 27))
#define UVOV_UVOV_CFG0_V12_UV_DEB_EN_V12_M       GENMASK(27, 27)
#define UVOV_UVOV_CFG0_V12_UV_DEB_EN_V12_X(x)    (((x) & GENMASK(27, 27)) >> 27)

#define UVOV_UVOV_CFG0_V12_OV_RST_EN_V12(x)      (((x) << 11) & GENMASK(11, 11))
#define UVOV_UVOV_CFG0_V12_OV_RST_EN_V12_M       GENMASK(11, 11)
#define UVOV_UVOV_CFG0_V12_OV_RST_EN_V12_X(x)    (((x) & GENMASK(11, 11)) >> 11)

#define UVOV_UVOV_CFG0_V12_UV_RST_EN_V12(x)      (((x) << 10) & GENMASK(10, 10))
#define UVOV_UVOV_CFG0_V12_UV_RST_EN_V12_M       GENMASK(10, 10)
#define UVOV_UVOV_CFG0_V12_UV_RST_EN_V12_X(x)    (((x) & GENMASK(10, 10)) >> 10)

#define UVOV_UVOV_CFG0_V12_OVR_RNG_SEL_V12(x)    (((x) << 4) & GENMASK(5, 4))
#define UVOV_UVOV_CFG0_V12_OVR_RNG_SEL_V12_M     GENMASK(5, 4)
#define UVOV_UVOV_CFG0_V12_OVR_RNG_SEL_V12_X(x)  (((x) & GENMASK(5, 4)) >> 4)

#define UVOV_UVOV_CFG0_V12_UVR_RNG_SEL_V12(x)    (((x) << 2) & GENMASK(3, 2))
#define UVOV_UVOV_CFG0_V12_UVR_RNG_SEL_V12_M     GENMASK(3, 2)
#define UVOV_UVOV_CFG0_V12_UVR_RNG_SEL_V12_X(x)  (((x) & GENMASK(3, 2)) >> 2)

#define UVOV_UVOV_CFG0_V12_OVR_DET_EN_V12(x)     (((x) << 1) & GENMASK(1, 1))
#define UVOV_UVOV_CFG0_V12_OVR_DET_EN_V12_M      GENMASK(1, 1)
#define UVOV_UVOV_CFG0_V12_OVR_DET_EN_V12_X(x)   (((x) & GENMASK(1, 1)) >> 1)

#define UVOV_UVOV_CFG0_V12_UVR_DET_EN_V12(x)     ((x) & GENMASK(0, 0))
#define UVOV_UVOV_CFG0_V12_UVR_DET_EN_V12_M      GENMASK(0, 0)
#define UVOV_UVOV_CFG0_V12_UVR_DET_EN_V12_X(x)   ((x) & GENMASK(0, 0))

/*      UVOV:UVOV_CFG:UVOV_CFG1_V12 */
#define UVOV_UVOV_CFG1_V12(t)     (t + 0x20)

#define UVOV_UVOV_CFG1_V12_UVOV_DEB_V12(x)       (((x) << 8) & GENMASK(31, 8))
#define UVOV_UVOV_CFG1_V12_UVOV_DEB_V12_M        GENMASK(31, 8)
#define UVOV_UVOV_CFG1_V12_UVOV_DEB_V12_X(x)     (((x) & GENMASK(31, 8)) >> 8)

#define UVOV_UVOV_CFG1_V12_OV_STS_V12(x)         (((x) << 1) & GENMASK(1, 1))
#define UVOV_UVOV_CFG1_V12_OV_STS_V12_M          GENMASK(1, 1)
#define UVOV_UVOV_CFG1_V12_OV_STS_V12_X(x)       (((x) & GENMASK(1, 1)) >> 1)

#define UVOV_UVOV_CFG1_V12_UV_STS_V12(x)         ((x) & GENMASK(0, 0))
#define UVOV_UVOV_CFG1_V12_UV_STS_V12_M          GENMASK(0, 0)
#define UVOV_UVOV_CFG1_V12_UV_STS_V12_X(x)       ((x) & GENMASK(0, 0))

/*      UVOV:UVOV_CFG:UVOV_CFG0_V18 */
#define UVOV_UVOV_CFG0_V18(t)     (t + 0x24)

#define UVOV_UVOV_CFG0_V18_OV_DEB_EN_V18(x)      (((x) << 28) & GENMASK(28, 28))
#define UVOV_UVOV_CFG0_V18_OV_DEB_EN_V18_M       GENMASK(28, 28)
#define UVOV_UVOV_CFG0_V18_OV_DEB_EN_V18_X(x)    (((x) & GENMASK(28, 28)) >> 28)

#define UVOV_UVOV_CFG0_V18_UV_DEB_EN_V18(x)      (((x) << 27) & GENMASK(27, 27))
#define UVOV_UVOV_CFG0_V18_UV_DEB_EN_V18_M       GENMASK(27, 27)
#define UVOV_UVOV_CFG0_V18_UV_DEB_EN_V18_X(x)    (((x) & GENMASK(27, 27)) >> 27)

#define UVOV_UVOV_CFG0_V18_OV_RST_EN_V18(x)      (((x) << 11) & GENMASK(11, 11))
#define UVOV_UVOV_CFG0_V18_OV_RST_EN_V18_M       GENMASK(11, 11)
#define UVOV_UVOV_CFG0_V18_OV_RST_EN_V18_X(x)    (((x) & GENMASK(11, 11)) >> 11)

#define UVOV_UVOV_CFG0_V18_UV_RST_EN_V18(x)      (((x) << 10) & GENMASK(10, 10))
#define UVOV_UVOV_CFG0_V18_UV_RST_EN_V18_M       GENMASK(10, 10)
#define UVOV_UVOV_CFG0_V18_UV_RST_EN_V18_X(x)    (((x) & GENMASK(10, 10)) >> 10)

#define UVOV_UVOV_CFG0_V18_OVR_RNG_SEL_V18(x)    (((x) << 4) & GENMASK(5, 4))
#define UVOV_UVOV_CFG0_V18_OVR_RNG_SEL_V18_M     GENMASK(5, 4)
#define UVOV_UVOV_CFG0_V18_OVR_RNG_SEL_V18_X(x)  (((x) & GENMASK(5, 4)) >> 4)

#define UVOV_UVOV_CFG0_V18_UVR_RNG_SEL_V18(x)    (((x) << 2) & GENMASK(3, 2))
#define UVOV_UVOV_CFG0_V18_UVR_RNG_SEL_V18_M     GENMASK(3, 2)
#define UVOV_UVOV_CFG0_V18_UVR_RNG_SEL_V18_X(x)  (((x) & GENMASK(3, 2)) >> 2)

#define UVOV_UVOV_CFG0_V18_OVR_DET_EN_V18(x)     (((x) << 1) & GENMASK(1, 1))
#define UVOV_UVOV_CFG0_V18_OVR_DET_EN_V18_M      GENMASK(1, 1)
#define UVOV_UVOV_CFG0_V18_OVR_DET_EN_V18_X(x)   (((x) & GENMASK(1, 1)) >> 1)

#define UVOV_UVOV_CFG0_V18_UVR_DET_EN_V18(x)     ((x) & GENMASK(0, 0))
#define UVOV_UVOV_CFG0_V18_UVR_DET_EN_V18_M      GENMASK(0, 0)
#define UVOV_UVOV_CFG0_V18_UVR_DET_EN_V18_X(x)   ((x) & GENMASK(0, 0))

/*      UVOV:UVOV_CFG:UVOV_CFG1_V18 */
#define UVOV_UVOV_CFG1_V18(t)     (t + 0x28)

#define UVOV_UVOV_CFG1_V18_UVOV_DEB_V18(x)       (((x) << 8) & GENMASK(31, 8))
#define UVOV_UVOV_CFG1_V18_UVOV_DEB_V18_M        GENMASK(31, 8)
#define UVOV_UVOV_CFG1_V18_UVOV_DEB_V18_X(x)     (((x) & GENMASK(31, 8)) >> 8)

#define UVOV_UVOV_CFG1_V18_OV_STS_V18(x)         (((x) << 1) & GENMASK(1, 1))
#define UVOV_UVOV_CFG1_V18_OV_STS_V18_M          GENMASK(1, 1)
#define UVOV_UVOV_CFG1_V18_OV_STS_V18_X(x)       (((x) & GENMASK(1, 1)) >> 1)

#define UVOV_UVOV_CFG1_V18_UV_STS_V18(x)         ((x) & GENMASK(0, 0))
#define UVOV_UVOV_CFG1_V18_UV_STS_V18_M          GENMASK(0, 0)
#define UVOV_UVOV_CFG1_V18_UV_STS_V18_X(x)       ((x) & GENMASK(0, 0))
