...
/* This file is autogenerated by cml-utils 2023-07-12 14:00:16 +0200.
 * Commit ID: 8e6dd1d0211f28100917d157425705078baaf05d
 */

/* LAN969X registers */

#ifndef _LAN969X_REGS_A0_H_
#define _LAN969X_REGS_A0_H_
...
#define AESB_ASC_TZAESBASC_WPMR_WPKEY(x)\
	(((uint32_t)(x) << 8) & GENMASK(31, 8))
...
#define AESB_ASC_TZAESBASC_WPSR_WPSRC(x)\
	(((uint32_t)(x) << 8) & GENMASK(23, 8))
...
#define AESB_ASC_TZAESBASC_VERSION_MFN(x)\
	(((uint32_t)(x) << 16) & GENMASK(18, 16))
...
#define CHIP_TOP_HW_STAT(t)       (t + 0x5c)

#define CHIP_TOP_HW_STAT_JTAG_SEL(x)\
	(((uint32_t)(x) << 2) & GENMASK(2, 2))
#define CHIP_TOP_HW_STAT_JTAG_SEL_M              GENMASK(2, 2)
#define CHIP_TOP_HW_STAT_JTAG_SEL_X(x)           (((x) & GENMASK(2, 2)) >> 2)

#define CHIP_TOP_HW_STAT_REFCLK_SEL(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
#define CHIP_TOP_HW_STAT_REFCLK_SEL_M            GENMASK(1, 1)
#define CHIP_TOP_HW_STAT_REFCLK_SEL_X(x)         (((x) & GENMASK(1, 1)) >> 1)

#define CHIP_TOP_HW_STAT_PLL_NBYPASS(x)          ((x) & GENMASK(0, 0))
#define CHIP_TOP_HW_STAT_PLL_NBYPASS_M           GENMASK(0, 0)
#define CHIP_TOP_HW_STAT_PLL_NBYPASS_X(x)        ((x) & GENMASK(0, 0))

/*      CHIP_TOP:DDR_PLL_CFG:DDR_PLL_CFG */
#define CHIP_TOP_DDR_PLL_CFG(t)   (t + 0xcc)

#define CHIP_TOP_DDR_PLL_CFG_DIVACK(x)\
	(((uint32_t)(x) << 27) & GENMASK(27, 27))
#define CHIP_TOP_DDR_PLL_CFG_DIVACK_M            GENMASK(27, 27)
#define CHIP_TOP_DDR_PLL_CFG_DIVACK_X(x)         (((x) & GENMASK(27, 27)) >> 27)

#define CHIP_TOP_DDR_PLL_CFG_NEWDIV(x)\
	(((uint32_t)(x) << 26) & GENMASK(26, 26))
#define CHIP_TOP_DDR_PLL_CFG_NEWDIV_M            GENMASK(26, 26)
#define CHIP_TOP_DDR_PLL_CFG_NEWDIV_X(x)         (((x) & GENMASK(26, 26)) >> 26)

#define CHIP_TOP_DDR_PLL_CFG_FILTER_RANGE(x)\
	(((uint32_t)(x) << 23) & GENMASK(25, 23))
#define CHIP_TOP_DDR_PLL_CFG_FILTER_RANGE_M      GENMASK(25, 23)
#define CHIP_TOP_DDR_PLL_CFG_FILTER_RANGE_X(x)   (((x) & GENMASK(25, 23)) >> 23)

#define CHIP_TOP_DDR_PLL_CFG_DIVQ(x)\
	(((uint32_t)(x) << 8) & GENMASK(22, 8))
#define CHIP_TOP_DDR_PLL_CFG_DIVQ_M              GENMASK(22, 8)
#define CHIP_TOP_DDR_PLL_CFG_DIVQ_X(x)           (((x) & GENMASK(22, 8)) >> 8)

#define CHIP_TOP_DDR_PLL_CFG_DIVR(x)\
	(((uint32_t)(x) << 2) & GENMASK(7, 2))
#define CHIP_TOP_DDR_PLL_CFG_DIVR_M              GENMASK(7, 2)
#define CHIP_TOP_DDR_PLL_CFG_DIVR_X(x)           (((x) & GENMASK(7, 2)) >> 2)

#define CHIP_TOP_DDR_PLL_CFG_ENA_CFG(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
#define CHIP_TOP_DDR_PLL_CFG_ENA_CFG_M           GENMASK(1, 1)
#define CHIP_TOP_DDR_PLL_CFG_ENA_CFG_X(x)        (((x) & GENMASK(1, 1)) >> 1)

#define CHIP_TOP_DDR_PLL_CFG_LOCK_STAT(x)        ((x) & GENMASK(0, 0))
#define CHIP_TOP_DDR_PLL_CFG_LOCK_STAT_M         GENMASK(0, 0)
#define CHIP_TOP_DDR_PLL_CFG_LOCK_STAT_X(x)      ((x) & GENMASK(0, 0))

/*      CHIP_TOP:DDR_PLL_CFG:DDR_PLL_FREQ_CFG */
#define CHIP_TOP_DDR_PLL_FREQ_CFG(t) (t + 0xd0)

#define CHIP_TOP_DDR_PLL_FREQ_CFG_BYPASS_ENA(x)\
	(((uint32_t)(x) << 31) & GENMASK(31, 31))
#define CHIP_TOP_DDR_PLL_FREQ_CFG_BYPASS_ENA_M   GENMASK(31, 31)
#define CHIP_TOP_DDR_PLL_FREQ_CFG_BYPASS_ENA_X(x)\
	(((x) & GENMASK(31, 31)) >> 31)

#define CHIP_TOP_DDR_PLL_FREQ_CFG_DIVFI(x)\
	(((uint32_t)(x) << 24) & GENMASK(30, 24))
#define CHIP_TOP_DDR_PLL_FREQ_CFG_DIVFI_M        GENMASK(30, 24)
#define CHIP_TOP_DDR_PLL_FREQ_CFG_DIVFI_X(x)     (((x) & GENMASK(30, 24)) >> 24)

#define CHIP_TOP_DDR_PLL_FREQ_CFG_DIVFF(x)       ((x) & GENMASK(23, 0))
#define CHIP_TOP_DDR_PLL_FREQ_CFG_DIVFF_M        GENMASK(23, 0)
#define CHIP_TOP_DDR_PLL_FREQ_CFG_DIVFF_X(x)     ((x) & GENMASK(23, 0))
...
#define CPU_GENERAL_STAT_REG_IF_ERR(x)\
	(((uint32_t)(x) << 7) & GENMASK(9, 7))
#define CPU_GENERAL_STAT_REG_IF_ERR_M            GENMASK(9, 7)
#define CPU_GENERAL_STAT_REG_IF_ERR_X(x)         (((x) & GENMASK(9, 7)) >> 7)

#define CPU_GENERAL_STAT_CSR_REG_IF_ERR(x)\
	(((uint32_t)(x) << 4) & GENMASK(6, 4))
...
#define CPU_CFG_INTR_INV(t)       (t + 0xb0)

#define CPU_CFG_INTR_INV_CFG_INTR_INV(x)         ((x) & GENMASK(5, 0))
#define CPU_CFG_INTR_INV_CFG_INTR_INV_M          GENMASK(5, 0)
#define CPU_CFG_INTR_INV_CFG_INTR_INV_X(x)       ((x) & GENMASK(5, 0))

/*      CPU:GCK_REGS:GCK_CFG */
#define CPU_GCK_CFG(t, r)         (t + (0xb4 + ((r) * 4)))

#define CPU_GCK_CFG_GCK_PRESCALER(x)\
	(((uint32_t)(x) << 16) & GENMASK(23, 16))
#define CPU_GCK_CFG_GCK_PRESCALER_M              GENMASK(23, 16)
#define CPU_GCK_CFG_GCK_PRESCALER_X(x)           (((x) & GENMASK(23, 16)) >> 16)

#define CPU_GCK_CFG_GCK_SRC_SEL(x)\
	(((uint32_t)(x) << 8) & GENMASK(9, 8))
...
#define CPU_SYSCNT_CNTCR_CNTCR_HDBG(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define CPU_SYSCNT_CNTSR_CNTSR_DBGH(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define CPU_SYSCNT_PIDR1_DES_0(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define CPU_SYSCNT_PIDR3_REVAND(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define CPU_SYSCNT_PIDR4_SIZE(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define CPU_SYSCNT_CIDR1_CLASS(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define CPU_SYSCNT_RO_PIDR1_DES_0(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define CPU_SYSCNT_RO_PIDR3_REVAND(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define CPU_SYSCNT_RO_PIDR4_SIZE(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define CPU_SYSCNT_RO_CIDR1_CLASS(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define FLEXCOM_FLEX_US_RHR_RXSYNH(x)\
	(((uint32_t)(x) << 15) & GENMASK(15, 15))
...
#define FLEXCOM_FLEX_US_THR_TXSYNH(x)\
	(((uint32_t)(x) << 15) & GENMASK(15, 15))
...
#define FLEXCOM_FLEX_US_BRGR_FP(x)\
	(((uint32_t)(x) << 16) & GENMASK(18, 16))
...
#define FLEXCOM_FLEX_US_FLR_RXFL(x)\
	(((uint32_t)(x) << 16) & GENMASK(21, 16))
...
#define FLEXCOM_FLEX_US_WPSR_WPVSRC(x)\
	(((uint32_t)(x) << 8) & GENMASK(23, 8))
...
#define FLEXCOM_FLEX_US_VERSION_USART_MFN(x)\
	(((uint32_t)(x) << 16) & GENMASK(18, 16))
...
#define GCB_SOFT_RST_SOFT_SWC_RST(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define GPV_PERIPH_ID_3_REV_AND(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define HMATRIX2_MATRIX_SRTSR0_SRTOP2_SRTSR0(x)\
	(((uint32_t)(x) << 8) & GENMASK(11, 8))
...
#define HMATRIX2_MATRIX_SRTSR0_SRTOP1_SRTSR0(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define OTP_OTP_PRGM_MODE_OTP_AUTO_REPAIR_ENA(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define OTP_OTP_PASS_FAIL_OTP_READ_PROHIBITED(x)\
	(((uint32_t)(x) << 3) & GENMASK(3, 3))
...
#define OTP_OTP_PASS_FAIL_OTP_PASS(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define PCIE_CFG_PCIE_STAT_LTSSM_STATE(x)\
	(((uint32_t)(x) << 6) & GENMASK(11, 6))
#define PCIE_CFG_PCIE_STAT_LTSSM_STATE_M         GENMASK(11, 6)
#define PCIE_CFG_PCIE_STAT_LTSSM_STATE_X(x)      (((x) & GENMASK(11, 6)) >> 6)

#define PCIE_CFG_PCIE_STAT_LINK_STATE(x)\
	(((uint32_t)(x) << 3) & GENMASK(5, 3))
...
#define PCIE_PHY_PCS_PHY_LINK_61_R_LOCAL_LF(x)\
	(((uint32_t)(x) << 8) & GENMASK(13, 8))
...
#define PCIE_PHY_PCS_PHY_LINK_61_R_TAP_DLY_SAT_THR(x)\
	(((uint32_t)(x) << 24) & GENMASK(29, 24))
#define PCIE_PHY_PCS_PHY_LINK_61_R_TAP_DLY_SAT_THR_M GENMASK(29, 24)
#define PCIE_PHY_PCS_PHY_LINK_61_R_TAP_DLY_SAT_THR_X(x)\
	(((x) & GENMASK(29, 24)) >> 24)

#define PCIE_PHY_PCS_PHY_LINK_61_R_TXCOEFF_PRELUT(x)\
	(((uint32_t)(x) << 30) & GENMASK(31, 30))
#define PCIE_PHY_PCS_PHY_LINK_61_R_TXCOEFF_PRELUT_M GENMASK(31, 30)
...
#define PCIE_PHY_PMA_PMA_CMU_0C_CFG_RSEL_2_0(x)\
	(((uint32_t)(x) << 4) & GENMASK(6, 4))
...
#define PCIE_PHY_PMA_PMA_CMU_44_R_CK_RESETB(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define PCIE_PHY_PMA_PMA_CMU_4A_R_SW_8G_GEN34(x)\
	(((uint32_t)(x) << 4) & GENMASK(4, 4))
...
#define PCIE_PHY_PMA_PMA_CMU_E0_PLL_LOL_UDL(x)\
	(((uint32_t)(x) << 4) & GENMASK(4, 4))
...
#define PCIE_PHY_PMA_PMA_LANE_0B_CFG_PD_CTLE(x)\
	(((uint32_t)(x) << 4) & GENMASK(4, 4))
...
#define PCIE_PHY_PMA_PMA_LANE_18_CFG_PI_HOLD(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define PCIE_PHY_PMA_PMA_LANE_1A_CFG_PI_EN(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define PCIE_PHY_PMA_PMA_LANE_31_CFG_CDR_RSTN(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define PCIE_PHY_PMA_PMA_LANE_31_CFG_R50_EN(x)\
	(((uint32_t)(x) << 5) & GENMASK(5, 5))
...
#define PCIE_PHY_PMA_PMA_LANE_36_CFG_EID_LP(x)\
	(((uint32_t)(x) << 4) & GENMASK(4, 4))
...
#define PCIE_PHY_PMA_PMA_LANE_36_CFG_PRBS_SEL(x)\
	(((uint32_t)(x) << 6) & GENMASK(6, 6))
...
#define PCIE_PHY_PMA_PMA_LANE_83_R_TX_POL_INV(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define PCIE_PHY_PMA_PMA_LANE_83_R_RX_POL_INV(x)\
	(((uint32_t)(x) << 3) & GENMASK(3, 3))
...
#define PCIE_PHY_PMA_PMA_LANE_84_R_LOL_CLR(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define PCIE_PHY_PMA_PMA_LANE_90_R_OSCAL_REG(x)\
	(((uint32_t)(x) << 5) & GENMASK(5, 5))
...
#define PCIE_PHY_PMA_PMA_LANE_93_R_REG_MANUAL(x)\
	(((uint32_t)(x) << 4) & GENMASK(4, 4))
...
#define PCIE_PHY_PMA_PMA_LANE_9F_R_RXDET_REG(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define PCIE_PHY_PMA_PMA_LANE_DF_LOL(x)\
	(((uint32_t)(x) << 1) & GENMASK(1, 1))
...
#define PCIE_PHY_PMA_PMA_LANE_DF_SQUELCH(x)\
	(((uint32_t)(x) << 3) & GENMASK(3, 3))
...
#define PCIE_PHY_WRAP_PCIE_PHY_CFG_APB_IF_RST(x)\
	(((uint32_t)(x) << 2) & GENMASK(2, 2))
...
#define TRNG_TRNG_VERSION_MFN(x)\
	(((uint32_t)(x) << 16) & GENMASK(18, 16))
...
#define TZAESBNS_TZAESB_VERSION_MFN(x)\
	(((uint32_t)(x) << 16) & GENMASK(18, 16))
...
#define TZAESBS_TZAESB_VERSION_MFN(x)\
	(((uint32_t)(x) << 16) & GENMASK(18, 16))
...
#define TZC_CSS_GATE_KEEPER_OPEN_STATUS(x)\
	(((uint32_t)(x) << 16) & GENMASK(16, 16))
...
#define TZC_CSS_FAIL_ID_0_VNET(x)\
	(((uint32_t)(x) << 24) & GENMASK(27, 24))
...
#define TZC_CSS_PID4_COUNT_4KB(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define TZC_CSS_PID1_JEP106_ID_3_0(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define TZC_MAIN_HSS_PID4_COUNT_4KB(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define TZC_MAIN_HSS_PID1_JEP106_ID_3_0(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define TZC_MAIN_HSS_PID3_REVAND(x)\
	(((uint32_t)(x) << 4) & GENMASK(7, 4))
...
#define XDMAC_XDMAC_GTYPE_NB_REQ(x)\
	(((uint32_t)(x) << 16) & GENMASK(22, 16))
#define XDMAC_XDMAC_GTYPE_NB_REQ_M               GENMASK(22, 16)
#define XDMAC_XDMAC_GTYPE_NB_REQ_X(x)            (((x) & GENMASK(22, 16)) >> 16)

#define XDMAC_XDMAC_GTYPE_FIFO_SZ(x)\
	(((uint32_t)(x) << 5) & GENMASK(15, 5))
...
#define XDMAC_XDMAC_CNDA_CH0_NDA_CH0(x)\
	(((uint32_t)(x) << 2) & GENMASK(31, 2))
...
#define XDMAC_XDMAC_VERSION_MFN(x)\
	(((uint32_t)(x) << 16) & GENMASK(18, 16))
