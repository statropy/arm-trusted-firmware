...
/* This file is autogenerated by cml-utils 2022-05-06 09:46:43 +0200.
 * Commit ID: 92e82dfee35244f83596078c8ed8fa252f1f685e
 */
...
#define CPU_PROC_CTRL_AARCH64_MODE_ENA(x)        (((x) << 8) & GENMASK(8, 8))
#define CPU_PROC_CTRL_AARCH64_MODE_ENA_M         GENMASK(8, 8)
#define CPU_PROC_CTRL_AARCH64_MODE_ENA_X(x)      (((x) & GENMASK(8, 8)) >> 8)

#define CPU_PROC_CTRL_L2_RST_INVALIDATE_DIS(x)   (((x) << 7) & GENMASK(7, 7))
#define CPU_PROC_CTRL_L2_RST_INVALIDATE_DIS_M    GENMASK(7, 7)
#define CPU_PROC_CTRL_L2_RST_INVALIDATE_DIS_X(x) (((x) & GENMASK(7, 7)) >> 7)

#define CPU_PROC_CTRL_L1_RST_INVALIDATE_DIS(x)   (((x) << 6) & GENMASK(6, 6))
#define CPU_PROC_CTRL_L1_RST_INVALIDATE_DIS_M    GENMASK(6, 6)
#define CPU_PROC_CTRL_L1_RST_INVALIDATE_DIS_X(x) (((x) & GENMASK(6, 6)) >> 6)

#define CPU_PROC_CTRL_BE_EXCEP_MODE(x)           (((x) << 5) & GENMASK(5, 5))
#define CPU_PROC_CTRL_BE_EXCEP_MODE_M            GENMASK(5, 5)
#define CPU_PROC_CTRL_BE_EXCEP_MODE_X(x)         (((x) & GENMASK(5, 5)) >> 5)

#define CPU_PROC_CTRL_VINITHI(x)                 (((x) << 4) & GENMASK(4, 4))
#define CPU_PROC_CTRL_VINITHI_M                  GENMASK(4, 4)
#define CPU_PROC_CTRL_VINITHI_X(x)               (((x) & GENMASK(4, 4)) >> 4)

#define CPU_PROC_CTRL_CFGTE(x)                   (((x) << 3) & GENMASK(3, 3))
#define CPU_PROC_CTRL_CFGTE_M                    GENMASK(3, 3)
#define CPU_PROC_CTRL_CFGTE_X(x)                 (((x) & GENMASK(3, 3)) >> 3)

#define CPU_PROC_CTRL_CP15S_DISABLE(x)           (((x) << 2) & GENMASK(2, 2))
#define CPU_PROC_CTRL_CP15S_DISABLE_M            GENMASK(2, 2)
#define CPU_PROC_CTRL_CP15S_DISABLE_X(x)         (((x) & GENMASK(2, 2)) >> 2)

#define CPU_PROC_CTRL_PROC_CRYPTO_DISABLE(x)     (((x) << 1) & GENMASK(1, 1))
#define CPU_PROC_CTRL_PROC_CRYPTO_DISABLE_M      GENMASK(1, 1)
#define CPU_PROC_CTRL_PROC_CRYPTO_DISABLE_X(x)   (((x) & GENMASK(1, 1)) >> 1)

#define CPU_PROC_CTRL_L2_FLUSH_REQ(x)            ((x) & GENMASK(0, 0))
#define CPU_PROC_CTRL_L2_FLUSH_REQ_M             GENMASK(0, 0)
#define CPU_PROC_CTRL_L2_FLUSH_REQ_X(x)          ((x) & GENMASK(0, 0))
...
#define GCB_GPIO_OUT_SET(t)       (t + 0xd8)

/*      GCB:GPIO:GPIO_OUT_SET1 */
#define GCB_GPIO_OUT_SET1(t)      (t + 0xdc)

/*      GCB:GPIO:GPIO_OUT_SET2 */
#define GCB_GPIO_OUT_SET2(t)      (t + 0xe0)
...
#define GCB_GPIO_OUT_CLR(t)       (t + 0xe4)

/*      GCB:GPIO:GPIO_OUT_CLR1 */
#define GCB_GPIO_OUT_CLR1(t)      (t + 0xe8)

/*      GCB:GPIO:GPIO_OUT_CLR2 */
#define GCB_GPIO_OUT_CLR2(t)      (t + 0xec)
...
/*      GCB:GPIO:GPIO_OUT */
#define GCB_GPIO_OUT(t)           (t + 0xf0)

/*      GCB:GPIO:GPIO_OUT1 */
#define GCB_GPIO_OUT1(t)          (t + 0xf4)

/*      GCB:GPIO:GPIO_OUT2 */
#define GCB_GPIO_OUT2(t)          (t + 0xf8)
...
/*      GCB:GPIO:GPIO_IN */
#define GCB_GPIO_IN(t)            (t + 0xfc)

/*      GCB:GPIO:GPIO_IN1 */
#define GCB_GPIO_IN1(t)           (t + 0x100)

/*      GCB:GPIO:GPIO_IN2 */
#define GCB_GPIO_IN2(t)           (t + 0x104)
...
/*      GCB:GPIO:GPIO_OE */
#define GCB_GPIO_OE(t)            (t + 0x108)

/*      GCB:GPIO:GPIO_OE1 */
#define GCB_GPIO_OE1(t)           (t + 0x10c)

/*      GCB:GPIO:GPIO_OE2 */
#define GCB_GPIO_OE2(t)           (t + 0x110)
...
/*      GCB:GPIO:GPIO_INTR */
#define GCB_GPIO_INTR(t)          (t + 0x114)

/*      GCB:GPIO:GPIO_INTR1 */
#define GCB_GPIO_INTR1(t)         (t + 0x118)

/*      GCB:GPIO:GPIO_INTR2 */
#define GCB_GPIO_INTR2(t)         (t + 0x11c)
...
#define GCB_GPIO_INTR_ENA(t)      (t + 0x120)

/*      GCB:GPIO:GPIO_INTR_ENA1 */
#define GCB_GPIO_INTR_ENA1(t)     (t + 0x124)

/*      GCB:GPIO:GPIO_INTR_ENA2 */
#define GCB_GPIO_INTR_ENA2(t)     (t + 0x128)
...
#define GCB_GPIO_INTR_IDENT(t)    (t + 0x12c)

/*      GCB:GPIO:GPIO_INTR_IDENT1 */
#define GCB_GPIO_INTR_IDENT1(t)   (t + 0x130)

/*      GCB:GPIO:GPIO_INTR_IDENT2 */
#define GCB_GPIO_INTR_IDENT2(t)   (t + 0x134)
...
/*      GCB:GPIO:GPIO_ALT */
#define GCB_GPIO_ALT(t, r)        (t + (0x138 + ((r) * 4)))

/*      GCB:GPIO:GPIO_ALT1 */
#define GCB_GPIO_ALT1(t, r)       (t + (0x144 + ((r) * 4)))

/*      GCB:GPIO:GPIO_ALT2 */
#define GCB_GPIO_ALT2(t, r)       (t + (0x150 + ((r) * 4)))
...
#define GCB_GPIO_SD_DEV_MAP(t, r) (t + (0x15c + ((r) * 4)))
...
#define GCB_GPIO_SD_SERDES_MAP(t, r) (t + (0x184 + ((r) * 4)))
